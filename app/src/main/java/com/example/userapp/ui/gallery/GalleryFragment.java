...
public class GalleryFragment extends Fragment {
        ...
        RecyclerView convoRecycler, otherRecycler,itFastRecycler;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            itFastRecycler= view.findViewById(R.id.itFastRecycler);
    ...
    private void getItFastImage() {
        reference.child("Convocation").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                itFastRecycler.setLayoutManager(new GridLayoutManager(getContext(), 3));
                itFastRecycler.setAdapter(adapter);
